...
altvar$results_or$table_or <- cbind(setNames(as.data.frame(altvar$results_or$g1_or$oddsratio[1:5]), "Control"),
                                    setNames(as.data.frame(altvar$results_or$g2_or$oddsratio[1:5]), "BTS"))

rownames(altvar$results_or$table_or) <- ref_labels_ormx
...
altvar$results_mfx$table_mfx <- cbind(setNames(as.data.frame(altvar$results_mfx$g1_mfx$mfxest[1:5]), "Control"),
                                              setNames(as.data.frame(altvar$results_mfx$g2_mfx$mfxest[1:5]), "BTS"))

rownames(altvar$results_mfx$table_mfx ) <- ref_labels_ormx
